    ...
    <DialogContent className="sm:max-w-[500px]">
      ...
      <div className="space-y-2">
        <div className="grid grid-cols-5 items-center gap-4">
          ...
          <Input value={supplier.nome} className='col-span-3' disabled />
        </div>
          <div className="grid grid-cols-5 items-center gap-4">
            <Label className='text-right'>CNPJ</Label>
            <Input value={supplier.cnpj.toString().replace(/(\d{2})(\d{3})(\d{3})(\d{4})(\d{2})/, "$1.$2.$3\\$4-$5")} className='col-span-3' disabled />
          </div> 
        <div className="grid grid-cols-5 items-center gap-4">
          <Label className='text-right'>Rua</Label>
          <Input value={supplier.rua} className='col-span-3' disabled />
        </div>
        <div className="grid grid-cols-5 items-center gap-4">
          <Label className='text-right'>Número</Label>
          <Input value={supplier.numero} className='col-span-3' disabled />
        </div>
        <div className="grid grid-cols-5 items-center gap-4">
          <Label className='text-right'>Cidade</Label>
          <Input value={supplier.cidade} className='col-span-3' disabled />
        </div>
        <div className="grid grid-cols-5 items-center gap-4">
          <Label className='text-right'>Estado</Label>
          <Input value={supplier.estado} className='col-span-3' disabled />
        </div>
      </div>
